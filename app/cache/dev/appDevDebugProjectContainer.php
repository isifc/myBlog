...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'home_user.registration.form.type' => 'getHomeUser_Registration_Form_TypeService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'myblog', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Home/BackendBundle/Entity'))), 'Home\\BackendBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('HomeBackendBundle' => 'Home\\BackendBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_daa681fdb00e90f1cf53dc7f1f05b2821542d3fb0a6b54eba0f666883eb1952f');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Home\\BackendBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Home\\BackendBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'home_user_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Home\\BackendBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Home\\BackendBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Home\\BackendBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the 'home_user.registration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Home\BackendBundle\Form\RegistrationFormType A Home\BackendBundle\Form\RegistrationFormType instance.
     */
    protected function getHomeUser_Registration_Form_TypeService()
    {
        return $this->services['home_user.registration.form.type'] = new \Home\BackendBundle\Form\RegistrationFormType();
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'/vendor/mwsimple/crud-generator/MWSimple/Bundle/CrudGeneratorBundle/Resources/translations/MWSimpleCrudGeneratorBundle.ca.yml'), 'ca', 'MWSimpleCrudGeneratorBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'/vendor/mwsimple/crud-generator/MWSimple/Bundle/CrudGeneratorBundle/Resources/translations/MWSimpleCrudGeneratorBundle.es.yml'), 'es', 'MWSimpleCrudGeneratorBundle');
        $instance->addResource('yml', ($this->targetDirs[3].'/vendor/mwsimple/crud-generator/MWSimple/Bundle/CrudGeneratorBundle/Resources/translations/MWSimpleCrudGeneratorBundle.en.yml'), 'en', 'MWSimpleCrudGeneratorBundle');
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Home/BackendBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Home/FrontendBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/mwsimple/crud-generator/MWSimple/Bundle/CrudGeneratorBundle/Resources/views'), 'MWSimpleCrudGenerator');
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Home/BackendBundle/Resources/views'), 'HomeBackend');
        $instance->addPath(($this->targetDirs[3].'/src/Home/FrontendBundle/Resources/views'), 'HomeFrontend');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('c653f7f34e6d86c84c9235d0030eb2abba5de763');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MWSimpleCrudGeneratorBundle' => 'MWSimple\\Bundle\\CrudGeneratorBundle\\MWSimpleCrudGeneratorBundle',
                'KnpPaginatorBundle' => 'Knp\\Bundle\\PaginatorBundle\\KnpPaginatorBundle',
                'LexikFormFilterBundle' => 'Lexik\\Bundle\\FormFilterBundle\\LexikFormFilterBundle',
                'HomeBackendBundle' => 'Home\\BackendBundle\\HomeBackendBundle',
                'HomeFrontendBundle' => 'Home\\FrontendBundle\\HomeFrontendBundle',
            ...
            'locale' => 'es',
            'secret' => 'c653f7f34e6d86c84c9235d0030eb2abba5de763',
            ...
            'kernel.secret' => 'c653f7f34e6d86c84c9235d0030eb2abba5de763',
            ...
            'fos_user.model.user.class' => 'Home\\BackendBundle\\Entity\\User',
            ...
            'fos_user.registration.form.type' => 'home_user_registration',
